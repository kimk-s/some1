...
{
    internal sealed class PlayerGameFront : IPlayerGameFront, ISyncDestination, ISyncPolatable
    {
        private readonly SyncArrayDestination _sync;
        private readonly NullableUnmanagedParticleDestination<Game> _game = new();
        private readonly FloatWaveDestination _cycles;

        internal PlayerGameFront(ISyncTime syncFrame)
        {
            _sync = new(
                _game,
        ...
        public ReadOnlyReactiveProperty<Game?> Game => _game.Value;
